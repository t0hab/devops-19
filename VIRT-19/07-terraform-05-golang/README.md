...
## Ответ
1. Установил через `brew install go`
2. Использую IDE от JetBrains
...
## Задача 3. Написание кода. Цель этого задания закрепить знания о базовом синтаксисе языка. Можно использовать редактор кода 
